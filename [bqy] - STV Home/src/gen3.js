function execute(url, page) {
    ...
    if (response.ok) {
        ...
        el.forEach(e => {
            ...
            if (viewCount > 5000 && chapterCount < 510 && !hasBlacklistedWord) {
                data.push({
