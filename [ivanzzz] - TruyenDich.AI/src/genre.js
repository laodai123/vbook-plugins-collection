...
function execute() {
    return Response.success([
        ...
        { title: "Tham Hiem", input: BASE_URL + "/the-loai/tham-hiem", script: "gen.js" },
        { title: "Linh Di", input: BASE_URL + "/the-loai/linh-di", script: "gen.js" },
        { title: "Mat The", input: BASE_URL + "/the-loai/mat-the", script: "gen.js" },
        { title: "Xuyen Nhanh", input: BASE_URL + "/the-loai/xuyen-nhanh", script: "gen.js" },
        { title: "Nu Cuong", input: BASE_URL + "/the-loai/nu-cuong", script: "gen.js" },
        { title: "Cung Dau", input: BASE_URL + "/the-loai/cung-dau", script: "gen.js" },
